...
angular.module("template/persianDatepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/persianDatepicker/popup.html",
    "<ul style=\"direction:ltr;\" class=\"dropdown-menu\" ng-style=\"{display: (isOpen && 'block') || 'none', top: position.top+'px', left: position.left+'px', right: position.left - 230 +'px'}\" ng-keydown=\"keydown($event)\">\n" +
